	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form action="${pageContext.request.contextPath}/register" method="post" class="form-horizontal" style="margin-top: 5px;">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" name="ckCode">
